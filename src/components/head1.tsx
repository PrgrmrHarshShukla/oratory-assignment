...
const Head1 = () => {
    return (
        <div className="flex flex-row justify-between items-center w-full h-[10vh] px-8 border-b border-gray-200">
            ...
            <div className="rounded-[36px] w-1/3 border border-gray-200 flex flex-row justify-between px-2 items-center h-[7vh]">

                <div className="flex flex-row justify-center items-center text-white gap-2 border border-[#FCB4A5] px-3 h-[5vh] cursor-pointer rounded-full bg-[#DC4A2D] hover:text-white hover:opacity-100 ">
                    <Briefcase size={17} />
                    <span className=" font-medium text-[17px]">Jobs</span>
                </div>
                <div className="flex flex-row justify-center items-center gap-2 hover:border border-[#FCB4A5] px-3 h-[5vh] cursor-pointer rounded-full hover:bg-[#DC4A2D] hover:text-white hover:opacity-100">
            ...
            <div className="flex flex-row justify-center items-center w-auto gap-4">
                <div className="relative">
                    <BellIcon size={24} />
                    <div className="w-[4px] h-[4px] rounded-full bg-[#e76d44] absolute top-[1px] right-[2px]"></div>
                </div>
